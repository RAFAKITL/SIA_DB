CREATE TABLE [dbo].[DFIE_EventosAcademicosListado_Historico] (
    ...
    [Desc_Docentes_H]            INT           DEFAULT ((0)) NOT NULL,
    [Desc_Docentes_M]            INT           DEFAULT ((0)) NOT NULL,
    [Desc_Directivos_H]          INT           DEFAULT ((0)) NOT NULL,
    [Desc_Directivos_M]          INT           DEFAULT ((0)) NOT NULL,
    [Desc_PAAE_H]                INT           DEFAULT ((0)) NOT NULL,
    [Desc_PAAE_M]                INT           DEFAULT ((0)) NOT NULL,
    [Desc_Alumnos_H]             INT           DEFAULT ((0)) NOT NULL,
    [Desc_Alumnos_M]             INT           DEFAULT ((0)) NOT NULL,
    [Desc_Externos_H]            INT           DEFAULT ((0)) NOT NULL,
    [Desc_Externos_M]            INT           DEFAULT ((0)) NOT NULL,
