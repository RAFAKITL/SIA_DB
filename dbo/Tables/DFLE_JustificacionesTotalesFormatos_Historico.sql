CREATE TABLE [dbo].[DFLE_JustificacionesTotalesFormatos_Historico] (
    [ID_JustificacionesTotalesFormatos] INT            IDENTITY (1, 1) NOT NULL,
    ...
    [id_Anio]                           INT            NULL,
    [id_Usuario]                        INT            NULL,
    PRIMARY KEY CLUSTERED ([ID_JustificacionesTotalesFormatos] ASC),
